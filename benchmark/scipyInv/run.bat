...
for /L %%i in (1,1,100) do (
    ...
    docker run --name scipyinv_container scipyinv
    docker cp scipyinv_container:/app/data ./
    docker cp scipyinv_container:/app/resources ./
    docker rm scipyinv_container
)
